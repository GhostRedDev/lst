...
class DashboardController extends Controller
{
    ...
    {
        // Contar pacientes con múltiples factores de riesgo
    ...
    private function getDemographicStats()
    {
        ...
        $riskFactors = Patient::select('risk_factors')
            ...
            ->flatMap(function($patient) {
                ...
                $decoded = json_decode($patient->risk_factors, true);
                return is_array($decoded) ? $decoded : [$patient->risk_factors];
            })
            ->filter()
            ->countBy()
            ->sortDesc()
    ...
    public function exportReport(Request $request)
    {
        try {
            ...
            $data = [
                'general_stats' => $this->getMainStats(),
