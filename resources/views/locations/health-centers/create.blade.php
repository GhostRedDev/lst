...
@section('title', 'Nuevo Centro de Salud - SPRL')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h3 mb-0">
                    <i class="fas fa-plus-circle"></i> Nuevo Centro de Salud
                </h1>
        ...
        <div class="col-md-8">
            <div class="card card-app">
                <div class="card-header-sprl">
                    <h5 class="mb-0">Información del Centro de Salud</h5>
                </div>
                <div class="card-body-sprl">
                    <form action="{{ route('locations.health-centers.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      placeholder="Dirección completa del centro de salud" required>{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Guardar Centro de Salud
                            </button>
                        </div>
                    </form>
                </div>
